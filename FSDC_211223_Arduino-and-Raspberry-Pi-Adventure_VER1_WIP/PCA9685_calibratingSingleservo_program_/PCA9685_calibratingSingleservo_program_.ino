...
void loop() {
  pwm.setPWM(0, 0, angleToPulse0(angle0));
  pwm.setPWM(1, 0, angleToPulse1(angle1));
  pwm.setPWM(2, 0, angleToPulse2(angle2));
  pwm.setPWM(3, 0, angleToPulse3(angle3));
  pwm.setPWM(4, 0, angleToPulse4(angle4));
  pwm.setPWM(5, 0, angleToPulse5(angle5));
  pwm.setPWM(6, 0, angleToPulse6(angle6));
  pwm.setPWM(7, 0, angleToPulse7(angle7));
  pwm.setPWM(8, 0, angleToPulse8(angle8));
  pwm.setPWM(9, 0, angleToPulse9(angle9));
  pwm.setPWM(10, 0, angleToPulse10(angle10));
  pwm.setPWM(11, 0, angleToPulse11(angle11));
  delay(rate);
