...
class ServoMotion {
    ...
    int pinNumber;
    int *functionCalibration;
    
  public:
    ServoMotion(int temp_angle, int temp_pos, int temp_updateInterval,
                int temp_pinNumber, int temp_functionCalibration) {

      *angle = temp_angle;
      pos = temp_pos;
      updateInterval = temp_updateInterval;
      pinNumber = temp_pinNumber;
      *functionCalibration = temp_functionCalibration;
    }
    ...
    void initialState() {
      ...
      delay(10);
      pwm.setPWM(pinNumber, 0, functionCalibration(90));
...
int rate = 500;
int angle0[] = {160, 90, 160, 90, 90, 90, 90};
int angle1[] = {90, 90, 90, 90, 0, 180, 90};
int angle2[] = {90, 180, 90, 180, 90, 90, 90};
int pos1 = 0;
int pos2 = 0;
int pos3 = 0;
int updateInterval1;
...
void setup() {
  ...
  delay(1500);
  updateInterval1 = 1000;
  updateInterval2 = 1000;
