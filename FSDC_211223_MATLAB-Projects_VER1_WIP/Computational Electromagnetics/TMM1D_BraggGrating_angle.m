...
% DEFINE LAYERS
DEV.UR = [1 1];                         %array of permeabilities in each layer of unit cell
DEV.ER = [1.5^2 2.1^2];                 %array of permittivities in each layer of unit cell
DEV.L0 = [0.25 0.18];                   %array of thickness of each layer of the unit cell
DEV.lam0 = 1;
