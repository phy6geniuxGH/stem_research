...
% GRID PARAMETERS
NRES = [80]; %grid resolution
BUFZ = 2*median(LAMBDA); %spacer region above and below grating
DEV.NPML = [0 0 100 100]; %size of PML at top and bottom of grid
