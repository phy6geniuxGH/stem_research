...
DEV_ER = (abs(1+(5-1).*rand(20,4))).^2; %array of permittivities in each layer of unit cell
DEVThick = abs((1+(3-1).*rand(20,4)));                   %array of thickness of each layer of the unit cell
DEV.lam0 = 1;
...
%Try a single sample:
sampleDevice = [[1.9 3.0, 2.0, 1.4]/3 [1.6^2 2.1^2 2.0^2 4.1^2]/25];
my_sampleDevice_label = 2;
