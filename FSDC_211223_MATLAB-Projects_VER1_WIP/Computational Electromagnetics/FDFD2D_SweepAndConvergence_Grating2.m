...
SRC.theta = [15] * degrees; %angle of incidence
THETA = SRC.theta;
...
BUFZ = 4*max(LAMBDA); %spacer region above and below grating
DEV.NPML = [0 0 400 400]; %size of PML at top and bottom of grid
