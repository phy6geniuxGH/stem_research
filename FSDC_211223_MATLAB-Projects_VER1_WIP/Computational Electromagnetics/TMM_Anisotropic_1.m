...
L = []*lam0;               %array of thickness of each layer
NP = 1;
...
Eztrn = -(kx_n*Etrnxy(1) + ky_n*Etrnxy(2))/kz_n_trn;
...
T = (transpose(ETRN)*conj(ETRN))*(real(kz_n_trn/ur2)/real(kz_n/ur1));
