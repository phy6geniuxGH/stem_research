...
% Movie Creation
MAKE_MOVIE = 0;
movie_title = 'Combed_Dielectric_Distribution_Animation_IV.mp4';
if MAKE_MOVIE == 1
...
elseif FREQ == 1
    ...
    for index = 1:10:(pos_x7 - pos_x0) 
        ...
        DEV.ER2(pos_x1+index:pos_x1+index+2,abs(round(pos_y1*(1-0.00000001*index.^2))):pos_y2) = er_2+0.015*index;
        %DEV.ER2(pos_x1+index:pos_x1+index+2,pos_y3:abs(round(pos_y4*(1+0.0000001*index.^2)))) = er_2+0.010*index;
        DEV.ER2(pos_x1+index:pos_x7,pos_y3:pos_y4) = er_2+100000;
    end
