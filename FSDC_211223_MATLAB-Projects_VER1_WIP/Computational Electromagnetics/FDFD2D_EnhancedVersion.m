...
elseif FREQ == 1
    ...
    DEV.ER2 = er1*ones(Nx2,Ny2);
    for index = 1:5:(pos_x7 - pos_x0) 
        DEV.ER2(pos_x1+index:pos_x1+index+2,round(pos_y1*(1-0.0001*index)):pos_y2) = er_2+0.015*index;
        DEV.ER2(pos_x1+index:pos_x7,pos_y3:pos_y4) = er_2+0.01*index;
    end
