...
%LAMBDA = [1:0.01:2];
SRC.theta = [-20] * degrees; %angle of incidence
THETA = SRC.theta;
...
%lamd = 1;
L = 1.25*LAMBDA(1); %period of grating
height = 0.85*LAMBDA(1);  %tooth height
% h = 0.85*LAMBDA(1);  %tooth height
ur = 1.5; %relative permeability of grating
er = 3.0; %dielectric constant of grating
% EXTERNAL MATERIALS
