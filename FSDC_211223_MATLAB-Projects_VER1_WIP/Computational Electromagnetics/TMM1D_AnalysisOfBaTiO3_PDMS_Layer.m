...
SRC.lam0 = 0.5;                        %free space wavelength
...
DEV.ER = [3 12];                 %array of permittivities in each layer of unit cell
DEV.L0 = [0.0012 0.0008];                   %array of thickness of each layer of the unit cell
DEV.lam0 = 1;
DEV.NP = 12;                            %number of times to cascade the unit cell
