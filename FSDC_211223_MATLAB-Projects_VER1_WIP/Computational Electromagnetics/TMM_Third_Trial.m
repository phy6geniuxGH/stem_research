...
% DEFINE LAYERS
UR = [ 1 1 ];                   %array of permeabilities in each layer
ER = [ 1 1 ];                   %array of permittivities in each layer
L = [ 0 0 ];                    %array of thickness of each layer
...
for i= 1:length(L)
    D_i{i} = SG12/(I - S11_i{i}*SG22);
    Fi{i} = S21_i{i}/(I - SG22*S11_i{i});

    SG11 = SG11 + D_i{i}*S11_i{i}*SG21;
    SG12 = D_i{i}*S12_i{i};
    SG21 = Fi{i}*SG21;
    SG22 = S22_i{i} + Fi{i}*SG22*S12_i{i};
end
