...
Ezsrc_temporal = exp(-((Time_element - time0)/tau).^2);
omega0 = (2*pi)*(freq);
Ezsrc_planewave = 1; %sin(omega0*Time_element);
...
Exsrc_temporal = exp(-((Time_element - time0)/tau).^2);
Exsrc_planewave = 1; %sin(omega0*Time_element);
