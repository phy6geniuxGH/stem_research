...
% Movie Creation
MAKE_MOVIE = 1;
movie_title = 'FDTD1D_BraggGrating.mp4';
if MAKE_MOVIE == 1
...
nz1 = 2 + ceil(BUFZ(1)/dz) + 1; %location of the top surface of the grating from the top of the grid
