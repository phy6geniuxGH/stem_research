...
% DEFINE LAYERS
UR = [];                   %array of permeabilities in each layer
ER = [];                   %array of permittivities in each layer
L = [];                    %array of thickness of each layer
...
for i = 1:length(L)
    [SG11, SG12, SG21, SG22] = star(SG11, SG12, SG21, SG22, S11_i{i},S12_i{i},S21_i{i},S22_i{i});
end
...
function [SAB11, SAB12, SAB21, SAB22] = star(SA11, SA12, SA21, SA22, SB11, SB12, SB21, SB22)
