...
% Benchmarked as of April 28, 2020
...
% DEFINE LAYERS
UR = [ 1 3 1 ];                   %array of permeabilities in each layer
ER = [ 3 3 3 ];                   %array of permittivities in each layer
...
D_i{3} = SG12/(I - S11_i{3}*SG22);
Fi{3} = S21_i{3}/(I - SG22*S11_i{3});

SG11 = SG11 + D_i{3}*S11_i{3}*SG21;
SG12 = D_i{3}*S12_i{3};
SG21 = Fi{3}*SG21;
SG22 = S22_i{3} + Fi{3}*SG22*S12_i{3};
