...
CONV = 1; % Enable Convergence Test
...
if CONV == 1
    ...
    for index = 1:length(NRES)
        ...
        mech_featY = [d t];
        d_minX = sum(mech_featX)/NRES(index);
        ...
        nx1 = 1 + floor((Nx2 - round(xTdev/dx2))/2); %location of the left side of the first tooth from the left side of the grid
