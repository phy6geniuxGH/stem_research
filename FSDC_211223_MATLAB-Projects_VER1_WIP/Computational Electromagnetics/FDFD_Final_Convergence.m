...
%     disp(['TDE(2) = '  num2str(100*T(index_m+2))]);
    ...
    disp(['REF(' num2str(NRES(index)) ') = ' num2str(REF(index))]);
    disp(['TRN(' num2str(NRES(index)) ') = ' num2str(TRN(index))]);
    disp(['CON(' num2str(NRES(index)) ') = ' num2str(CON(index))]);
...
%     colorbar;
    ...
    %clearvars -except f0 lam0 LAMBDA theta MODE fd  lamd x1 x2 x3 L d t ur er ur1 er1 ur2 er2 NRES NPML BUFZ xbc ybc centimeters millimeters meters degrees seconds hertz gigahertz megahertz c0 fig
end
