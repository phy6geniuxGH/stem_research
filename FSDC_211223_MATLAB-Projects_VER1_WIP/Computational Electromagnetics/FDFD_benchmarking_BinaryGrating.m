...
theta = -30* degrees; %angle of incidence
MODE = 'H'; %electromagnetic mode, 'E' or 'H'
% GRATING PARAMETERS
fd = 8.0 * gigahertz; %design frequency
lamd = c0/fd; %design wavelength
L = 1.25*lam0; %period of grating
f = 0.5*L; %duty cycle of the grating
d = 0.25*lam0; %grating depth
mech_feat = [f L d];
...
nx2 = nx1 + round(f/dx2)-1;

ny1 = floor((Ny2 - round(yTdev/dy2))/2);
ny2 = ny1 + round(d/dy2);
