...
DEV.ER = [1.6^2 2.1^2 2.0^2 4.1^2];                 %array of permittivities in each layer of unit cell
DEV.L0 = [1.9 3.0, 2.0, 1.4];                   %array of thickness of each layer of the unit cell
DEV.lam0 = 1;
