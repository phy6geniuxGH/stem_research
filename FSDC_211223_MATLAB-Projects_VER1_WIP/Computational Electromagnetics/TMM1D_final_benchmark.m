...
SRC.theta = 55 * degrees;               %elevation angle
SRC.phi = 125 * degrees;                 %azimuthal angle
SRC.pte = 0;                    %amplitude of TE polarization
SRC.ptm = 1;                   %amplitude of TM polarization

% EXTERNAL MATERIALS
DEV.ur1 = 3.0;                          %permeability in the reflection region
DEV.er1 = 1.0;                          %permittivity in the reflection region
DEV.ur2 = 3.0;                          %permeability in the transmission region
DEV.er2 = 2.0;                          %permittivity in the transmission region

% DEFINE LAYERS
DEV.UR = [1 3 1];                        %array of permeabilities in each layer of unit cell
DEV.ER = [3 3 3];                        %array of permittivities in each layer of unit cell
DEV.L0 = [0.4 0.8 1.3];                    %array of thickness of each layer of the unit cell
DEV.lam0 = SRC.lam0;
DEV.NP = 78536124;                            %number of times to cascade the unit cell
